...
public class XpathSelectors {
    ...
    public void selectorsRadioButtonPage() {
        ...
        //WebElement btnImpressive = driver.findElement(By.
        //     cssSelector("label[for='impressiveRadio']"));
        WebElement btnImpressive = driver.findElement(By
...
//                        "div[class='card mt-4 top-card']:last-child"));
        WebElement divBookStore = driver.findElement(By
                .xpath("//div[@class='category-cards']" +
                        "//div[@class='card mt-4 top-card'][last()]"));
        divBookStore.click();
        pause(5);

        driver.navigate().back();
        WebElement divTextBox = driver.findElement(By
                .cssSelector("div[class='category-cards'] " +
                        "div[class='card mt-4 top-card']:nth-child(2)"));
        divTextBox.click();
        WebElement btnPracticeForm = driver.findElement(By
                .xpath("//*[text()='Practice Form']"));
